...
const Icons = {
    ...
    logo: (props: LucideProps) => (
        <svg {...props} version="1.0" xmlns="http://www.w3.org/2000/svg" width="600px" height="512px" viewBox="0 0 512 512" preserveAspectRatio="xMidYMid meet">
            <g fill="#ffffff">
                <path d="M176.2 475.9 c-88.7 -0.4 -161.7 -0.9 -162.2 -1.1 -0.9 -0.3 242 -437.7 243.1 -437.8 0.3 0 21.4 39.7 46.9 88.2 25.5 48.6 47.2 89.8 48.2 91.6 l2 3.2 -33 0 -33 0 -15.5 -28.2 c-8.5 -15.5 -15.9 -28.4 -16.3 -28.5 -1 -0.3 -136.8 245.6 -136.1 246.3 0.2 0.2 45.6 0.7 101 1.1 l100.6 0.6 9.5 20.1 c5.2 11.1 12.2 25.8 15.5 32.9 l6 12.7 -7.7 -0.2 c-4.2 -0.1 -80.3 -0.5 -169 -0.9z"/>
                <path d="M398.5 429.3 c-13 -26.3 -27 -54.8 -31.2 -63.4 l-7.5 -15.6 -49.5 -0.6 c-27.3 -0.4 -58.1 -0.7 -68.5 -0.7 l-18.8 0 16.8 -33.6 16.7 -33.6 10.4 0.6 c5.7 0.3 36.8 0.6 69.1 0.6 l58.8 0 49.2 93.8 c27.1 51.5 50.2 95.2 51.2 97 l2 3.2 -37.5 0 -37.5 0 -23.7 -47.7z"/>
            </g>
        </svg>
    ),
