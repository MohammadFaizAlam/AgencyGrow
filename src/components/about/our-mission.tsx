                    ...
                    <div className="flex flex-col px-2 md:px-0 h-full">
                        ...
                        <Container delay={0.1}>
                            <h2 className="text-3xl md:text-4xl font-semibold text-left tracking-tight mt-4">
                                On a mission to fuel growth — not just clicks
                            </h2>
                        </Container>
                        <Container delay={0.3}>
                            <p className="text-base md:text-lg text-muted-foreground text-left mt-2 max-w-2xl">
                                Great marketing doesn’t feel like marketing. That’s why every campaign we craft is designed to build real connections, spark action, and create momentum for your brand. 
                            </p>
                            <p className="text-base lg:text-lg font-normal text-muted-foreground mt-4">
                                From strategy to scale, we’re here to be the partner you trust to drive meaningful growth — not just vanity metrics.
                            </p>
                        </Container>
                    </div>
